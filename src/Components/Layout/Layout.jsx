        ...
        <div className='flex flex-col md:flex-row justify-between items-center'>
          ...
          <div className='w-full md:w-1/3'>
            <div
              className={`bg-white ${
                currentSlide === 0
                  ? styles['custom-shadow-black']
                  : styles['custom-shadow-pink']
              } rounded-md p-8`}
            >
              <Outlet />
            </div>
      ...
      <div className='bg-gray-100 py-8'>
        <div className='text-black container mx-auto'>
          <h2 className='text-3xl text-center font-bold mb-8'>
            Why Join Our Student Community?
          </h2>
          <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
            <div className='flex flex-col items-center'>
              ...
              <p className='text-gray-700 text-center'>
                Connect and network with fellow students in your field of
                interest.
              </p>
            </div>
            <div className='flex flex-col items-center'>
              ...
              <p className='text-gray-700 text-center'>
                Showcase your projects, photos, and videos to gain exposure and
                feedback.
              </p>
            </div>
            <div className='flex flex-col items-center'>
              ...
              <p className='text-gray-700 text-center'>
                Learn from educational resources, participate in discussions,
